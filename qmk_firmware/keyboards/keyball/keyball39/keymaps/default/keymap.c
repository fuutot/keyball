...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
    ...
    KC_LNG2  , KC_LGUI  , KC_LALT  ,LT(1,KC_TAB),LT(2,KC_SPC),LT(3,KC_ESC),LT(4,KC_ENT),LT(5,KC_BSPC),LSFT_T(KC_LNG2),KC_RALT,KC_RGUI, KC_LNG1
  ),
  ...
  [2] = LAYOUT_universal(
    XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  ,                            G(KC_A)  , G(KC_V)  , G(KC_C)  , G(KC_X)  , G(KC_Z)  ,
    KC_LALT  , KC_LCTL  , KC_LGUI  , KC_LSFT  , XXXXXXX  ,                            XXXXXXX  , KC_BTN1  , KC_BTN2  , KC_LCTL  , KC_LALT  ,
